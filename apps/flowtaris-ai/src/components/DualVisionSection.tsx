...
const DEFAULT_COM_PILLARS = [
  {
    ...
    body: 'Flowtaris.com delivers decade-deep ERP implementations across NetSuite, SAP, Workday, and Coupa — with a global footprint. We are the partner enterprises call when execution cannot fail.',
    tag: 'Enterprise Operations',
  },
  {
    number: '02',
    title: 'Governance by Design',
    subtitle: 'SOC 2 (Pending) · GDPR · ISO 27001 (Pending) baked in',
...
const DEFAULT_SECTION = {
  ...
  unifyingText: 'Flowtaris AI does not replace what Flowtaris.com has built — it deepens it. Our AI products inherit the same governance controls, implementation expertise, and enterprise trust model that our global clients depend on. This is AI with accountability, not a proof-of-concept.',
  stats: [
    { label: 'Global', sub: 'Reach' },
    { label: 'Growing', sub: 'Enterprises' },
  ...
  left: {
    ...
    intro: 'The foundation every enterprise finance team can stake their ERP on. Decade-deep implementations, partner-grade governance, and a global delivery network built for when execution cannot fail.',
