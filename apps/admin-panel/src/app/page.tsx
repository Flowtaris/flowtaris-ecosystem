  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {/* Site Config Card */}
        <Link href="/site-config" className="group">
        ...
        {/* Platforms Card */}
        <Link href="/platforms" className="group">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow hover:shadow-lg transition-shadow group-hover:shadow-xl">
            <div className="flex items-center justify-between mb-4">
              <div>
        ...
        <Link href="/assessment-config" className="group">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow hover:shadow-lg transition-shadow group-hover:shadow-xl">
            <div className="flex items-center justify-between mb-4">
              <div>
        ...
        {/* ROI Config Card */}
        <Link href="/roi-config" className="group">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow hover:shadow-lg transition-shadow group-hover:shadow-xl">
            <div className="flex items-center justify-between mb-4">
              <div>
